...
class Vendor(models.Model):
    ...
    address = models.CharField(max_length=100, default="Bole Rwanda.")
    contact = models.CharField(max_length=100, default="+251 912 345 678")
...
class Product(models.Model):
    ...
    kinash = models.BooleanField(default=False)
    trending = models.BooleanField(default=False)
    itop_rated = models.BooleanField(default=False)
    arecentlyadded = models.BooleanField(default=False)
...
################################ Product Review, wshlist, address #########################################
################################ Product Review, wshlist, address #########################################
################################ Product Review, wshlist, address #########################################
################################ Product Review, wshlist, address #########################################
