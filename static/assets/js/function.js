...
$("#commentForm").submit(function(e){
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.bool == true){
                $("#review-res").html("Review Added succefully.")
                ...
                _html += '<img src="https://upload.wikimedia.org/wikipedia/commons/2/2c/Default_pfp.svg" alt="" />'
...
$(document).ready(function (){
    ...
    $(".update-product").on("click", function(){
        ...
        console.log("P Qty:", product_quantity);
    ...
    $(document).on("submit", "#contact-form-ajax", function(e){
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                $("#message-response").html("Message sent successflly!")
            }
        })
    })
})
